            ...
            <main class="frosted-panel">
                ...
                <section id="publications">
                    ...
                    <div>
                        ...
                        <span class="tag">"Malware Analysis"</span> <span class="tag">"Reverse Engineering"</span>
                    </div>
                </section>
                ...
                <section id="certs">
                    ...
                    <ul class="certs">
                        <li class="cert-item">
                            ...
                            "SOC Level 2 · TryHackMe · May 2026"
                        </li>
                        <li class="cert-item">
                            <div class="cert-label">"Certified"</div>
                            "Google Cybersecurity Certificate · Apr 2024"
                        </li>
                    </ul>
                </section>
            </main>
